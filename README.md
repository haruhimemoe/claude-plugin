...
A [Claude Code plugin](https://docs.claude.com/en/docs/claude-code/plugins) of skills for building osu! tools: the osu! API v2, the rules for officially supported tournaments, the hinai beatmap mirror, and the `@haruhime/*` packages.
...
/plugin install haruhime@haruhime
```
...
| `osu-mappool-content-rules` | Checking whether a map may be used in an officially supported tournament, by hand or with `@haruhime/compliance`. |
