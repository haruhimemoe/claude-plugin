...
| Map | Verdict | Why |
| --- | --- | --- |
| Graveyard map of an Igorrr song | Not allowed | Igorrr is restricted; graveyard has no exemption |
...
- The data is a snapshot (`UPSTREAM.committedAt` in the package). It can lag the wiki. On the 2026-02-18 wiki revision, gxxberlol's two banned tracks ("KICKICKICKICKICKICKIKI" and "newb artist rave") aren't in omc's data yet, so code says ok for them. Check the wiki for anything a tool marks ok but you're unsure of.
